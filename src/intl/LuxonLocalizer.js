...
const weekRangeFormat = ({ start, end }, culture, local) => `${local.format(start, 'MMMM dd', culture)} — ${local.format(
  end,
...
const LuxonLocalizer = function luxonLocalizer(DateTime, { firstDayOfWeek }) {
